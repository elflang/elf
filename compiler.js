...
getenv = function (k, p) {
  if (typeof(k) === "string") {
    var _i = (environment42.length || 0) - 1;
    while (_i >= 0) {
      var frame = environment42[_i];
      var b = frame[k];
...
var variable63 = function (k) {
  var _i1 = (environment42.length || 0) - 1;
  while (_i1 >= 0) {
    var frame = environment42[_i1];
    var b = frame[k];
    if (!( typeof(b) === "undefined" || b === null)) {
...
var infix63 = function (x) {
  var _x88 = getop(x);
  return(!( typeof(_x88) === "undefined" || _x88 === null));
};
var compile_args = function (args) {
  var s = "(";
  var c = "";
  var _x89 = args;
  var _n9 = _x89.length || 0;
  var _i11 = 0;
  while (_i11 < _n9) {
    var x = _x89[_i11];
    s = s + c + compile(x);
...
compile_function = function (args, body) {
  ...
  var _x92 = compile(body, {_stash: true, stmt: true});
  indent_level42 = indent_level42 - 1;
  var _body = _x92;
  var ind = indentation();
  var _e27;
...
setenv("%if", {_stash: true, tr: true, special: function (cond, cons, alt) {
  ...
  indent_level42 = indent_level42 + 1;
  var _x128 = compile(cons, {_stash: true, stmt: true});
  indent_level42 = indent_level42 - 1;
  var _cons1 = _x128;
  var _e35;
  if (alt) {
    indent_level42 = indent_level42 + 1;
    var _x129 = compile(alt, {_stash: true, stmt: true});
    indent_level42 = indent_level42 - 1;
    _e35 = _x129;
  }
  var _alt1 = _e35;
...
setenv("%try", {_stash: true, tr: true, special: function (form) {
  ...
  var ind = indentation();
  indent_level42 = indent_level42 + 1;
  var _x140 = compile(form, {_stash: true, stmt: true});
  indent_level42 = indent_level42 - 1;
  var body = _x140;
  var hf = ["return", ["%array", false, ["get", e, "\"message\""], ["get", e, "\"stack\""]]];
  indent_level42 = indent_level42 + 1;
  var _x145 = compile(hf, {_stash: true, stmt: true});
  indent_level42 = indent_level42 - 1;
  var h = _x145;
  return(ind + "try {\n" + body + ind + "}\n" + ind + "catch (" + e + ") {\n" + h + ind + "}\n");
}, stmt: true});
