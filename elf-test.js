...
add(tests, ["empty", function () {
  ...
  var _x546 = [];
  _x546.a = true;
  if (! equal63(false, empty63(_x546))) {
    failed = failed + 1;
    var _x547 = [];
    _x547.a = true;
    return("failed: expected " + str(false) + ", was " + str(empty63(_x547)));
  } else {
    passed = passed + 1;
  }
  ...
  var _x548 = [];
  _x548.b = false;
  if (! equal63(false, empty63(_x548))) {
    failed = failed + 1;
    var _x549 = [];
    _x549.b = false;
    return("failed: expected " + str(false) + ", was " + str(empty63(_x549)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["with", function () {
  ...
  if (! equal63(10, x)) {
    ...
    var _x599 = 9;
    _x599 = _x599 + 1;
    return("failed: expected " + str(10) + ", was " + str(_x599));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["join", function () {
  ...
  var _x683 = ["a"];
  _x683.b = true;
  if (! equal63(_x683, join(["a"], {b: true}))) {
    failed = failed + 1;
    var _x685 = ["a"];
    _x685.b = true;
    return("failed: expected " + str(_x685) + ", was " + str(join(["a"], {b: true})));
  } else {
    passed = passed + 1;
  }
  var _x687 = ["a", "b"];
  ...
  var _x689 = ["b"];
  _x689.b = true;
  if (! equal63(_x687, join(["a"], _x689))) {
    failed = failed + 1;
    var _x690 = ["a", "b"];
    _x690.b = true;
    var _x692 = ["b"];
    _x692.b = true;
    return("failed: expected " + str(_x690) + ", was " + str(join(["a"], _x692)));
  } else {
    passed = passed + 1;
  }
  var _x693 = ["a"];
  ...
  var _x694 = ["a"];
  _x694.b = true;
  if (! equal63(_x693, join(_x694, {b: 10}))) {
    failed = failed + 1;
    var _x695 = ["a"];
    _x695.b = 10;
    var _x696 = ["a"];
    _x696.b = true;
    return("failed: expected " + str(_x695) + ", was " + str(join(_x696, {b: 10})));
  } else {
    passed = passed + 1;
  }
  var _x697 = [];
  ...
  var _x698 = [];
  _x698.b = 10;
  if (! equal63(_x697, join({b: true}, _x698))) {
    failed = failed + 1;
    var _x699 = [];
    _x699.b = 10;
    var _x700 = [];
    _x700.b = 10;
    return("failed: expected " + str(_x699) + ", was " + str(join({b: true}, _x700)));
  } else {
    passed = passed + 1;
  }
  var _x701 = ["a"];
...
add(tests, ["reverse", function () {
  ...
  var _x709 = [1, 2, 3];
  _x709.a = true;
  if (! equal63(_x708, reverse(_x709))) {
    failed = failed + 1;
    var _x710 = [3, 2, 1];
    _x710.a = true;
    var _x711 = [1, 2, 3];
    _x711.a = true;
    return("failed: expected " + str(_x710) + ", was " + str(reverse(_x711)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["map", function () {
  ...
  var _x741 = [2, 4, 6];
  _x741.b = 8;
  var _x742 = [1, 2, 3, 4, 5, 6];
  _x742.b = 8;
  _x742.a = 7;
  if (! equal63(_x741, map(evens, _x742))) {
    failed = failed + 1;
    var _x743 = [2, 4, 6];
    _x743.b = 8;
    var _x744 = [1, 2, 3, 4, 5, 6];
    _x744.b = 8;
    _x744.a = 7;
    return("failed: expected " + str(_x743) + ", was " + str(map(evens, _x744)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["cut", function () {
  ...
  var _x771 = [1, 2];
  _x771.a = true;
  if (! equal63(_x770, cut(_x771, 1))) {
    failed = failed + 1;
    var _x772 = [2];
    _x772.a = true;
    var _x773 = [1, 2];
    _x773.a = true;
    return("failed: expected " + str(_x772) + ", was " + str(cut(_x773, 1)));
  } else {
    passed = passed + 1;
  }
  var _x774 = [];
  ...
  if (! equal63(_x774, cut(_x775))) {
    ...
    _x777.b = 2;
    _x777.a = true;
    return("failed: expected " + str(_x776) + ", was " + str(cut(_x777)));
  } else {
    passed = passed + 1;
  }
  var t = [1, 2, 3];
  ...
  var _x780 = [];
  _x780.a = true;
  if (! equal63(_x780, cut(_t1, _35(_t1)))) {
    failed = failed + 1;
    var _x781 = [];
    _x781.a = true;
    return("failed: expected " + str(_x781) + ", was " + str(cut(_t1, _35(_t1))));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["keep", function () {
  ...
  var _x845 = [2, 4, 6];
  _x845.b = 8;
  var _x846 = [1, 2, 3, 4, 5, 6];
  _x846.b = 8;
  _x846.a = 7;
  if (! equal63(_x845, keep(even63, _x846))) {
    failed = failed + 1;
    var _x847 = [2, 4, 6];
    _x847.b = 8;
    var _x848 = [1, 2, 3, 4, 5, 6];
    _x848.b = 8;
    _x848.a = 7;
    return("failed: expected " + str(_x847) + ", was " + str(keep(even63, _x848)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["find", function () {
  ...
  var _x867 = [2, 4];
  _x867.foo = 7;
  if (! equal63(true, in63(7, _x867))) {
    failed = failed + 1;
    var _x868 = [2, 4];
    _x868.foo = 7;
    return("failed: expected " + str(true) + ", was " + str(in63(7, _x868)));
  } else {
    passed = passed + 1;
  }
  var _x869 = [2, 4];
  _x869.bar = true;
  if (! equal63(true, in63(true, _x869))) {
    failed = failed + 1;
    var _x870 = [2, 4];
    _x870.bar = true;
    return("failed: expected " + str(true) + ", was " + str(in63(true, _x870)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["apply", function () {
  ...
  var _x908 = [];
  _x908.foo = 42;
  if (! equal63(42, apply(function (_x906) {
    var _id29 = _x906;
    var foo = _id29.foo;
    return(foo);
  }, [_x908]))) {
    ...
    var _x911 = [];
    _x911.foo = 42;
    return("failed: expected " + str(42) + ", was " + str(apply(function (_x909) {
      var _id30 = _x909;
      var foo = _id30.foo;
      return(foo);
    }, [_x911])));
...
add(tests, ["parameters", function () {
  if (! equal63(42, (function (_x936) {
    var _id31 = _x936;
    var a = _id31[0];
    return(a);
  })([42]))) {
    failed = failed + 1;
    return("failed: expected " + str(42) + ", was " + str((function (_x938) {
      var _id32 = _x938;
      var a = _id32[0];
      return(a);
    })([42])));
  ...
  if (! equal63(42, (function (_x968) {
    ...
    var _x971 = [];
    _x971.foo = 42;
    return("failed: expected " + str(42) + ", was " + str((function (_x970) {
      var _id43 = _x970;
      var foo = _id43.foo;
      return(foo);
    })(_x971)));
  ...
  var _x975 = [];
  _x975.foo = 42;
  if (! equal63([10, 20, 42], _f2(10, _x975, {_stash: true, bar: 20}))) {
    failed = failed + 1;
    var _x977 = [];
    _x977.foo = 42;
    return("failed: expected " + str([10, 20, 42]) + ", was " + str(_f2(10, _x977, {_stash: true, bar: 20})));
  } else {
    passed = passed + 1;
  }
  var _f3 = function () {
