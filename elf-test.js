...
add(tests, ["list", function () {
  ...
  var _x119 = [];
  _x119.foo = 17;
  if (! equal63(17, _x119.foo)) {
    failed = failed + 1;
    var _x120 = [];
    _x120.foo = 17;
    return("failed: expected " + str(17) + ", was " + str(_x120.foo));
  } else {
    passed = passed + 1;
  }
  var _x121 = [1];
  ...
  var _x123 = [];
  _x123.foo = true;
  if (! equal63(true, _x123.foo)) {
    failed = failed + 1;
    var _x124 = [];
    _x124.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x124.foo));
  } else {
    passed = passed + 1;
  }
  var _x125 = [];
  ...
  var _x128 = [];
  _x128.foo = true;
  if (! equal63(true, hd([_x128]).foo)) {
    failed = failed + 1;
    var _x130 = [];
    _x130.foo = true;
    return("failed: expected " + str(true) + ", was " + str(hd([_x130]).foo));
  } else {
    passed = passed + 1;
  }
  var _x131 = [];
  ...
  var _x136 = [];
  _x136.b = false;
  if (! equal63(_x135, _x136)) {
    failed = failed + 1;
    var _x137 = [];
    _x137.b = false;
    var _x138 = [];
    _x138.b = false;
    return("failed: expected " + str(_x137) + ", was " + str(_x138));
  } else {
    passed = passed + 1;
  }
  var _x139 = [];
...
add(tests, ["quasiquote", function () {
  ...
  var _x313 = [];
  _x313.foo = true;
  if (! equal63(true, _x313.foo)) {
    failed = failed + 1;
    var _x314 = [];
    _x314.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x314.foo));
  } else {
    passed = passed + 1;
  }
  var _a1 = 17;
  ...
  var _x317 = [];
  _x317.foo = _a1;
  if (! equal63(17, _x317.foo)) {
    failed = failed + 1;
    var _x318 = [];
    _x318.foo = _a1;
    return("failed: expected " + str(17) + ", was " + str(_x318.foo));
  } else {
    passed = passed + 1;
  }
  var _x319 = [];
  _x319.foo = _a1;
  if (! equal63(2, _35(join(_x319, b)))) {
    failed = failed + 1;
    var _x320 = [];
    _x320.foo = _a1;
    return("failed: expected " + str(2) + ", was " + str(_35(join(_x320, b))));
  } else {
    passed = passed + 1;
  }
  var _x321 = [];
  _x321.foo = _a1;
  if (! equal63(17, _x321.foo)) {
    failed = failed + 1;
    var _x322 = [];
    _x322.foo = _a1;
    return("failed: expected " + str(17) + ", was " + str(_x322.foo));
  } else {
    passed = passed + 1;
  }
  var _x323 = [1];
  _x323.a = 10;
  if (! equal63(_x323, join([1], _c))) {
    failed = failed + 1;
    var _x325 = [1];
    _x325.a = 10;
    return("failed: expected " + str(_x325) + ", was " + str(join([1], _c)));
  } else {
    passed = passed + 1;
  }
  var _x327 = [1];
  _x327.a = 10;
  if (! equal63(_x327, join([1], d))) {
    failed = failed + 1;
    var _x329 = [1];
    _x329.a = 10;
    return("failed: expected " + str(_x329) + ", was " + str(join([1], d)));
  } else {
    passed = passed + 1;
  }
  var _x332 = [];
  _x332.foo = true;
  if (! equal63(true, hd([_x332]).foo)) {
    failed = failed + 1;
    var _x334 = [];
    _x334.foo = true;
    return("failed: expected " + str(true) + ", was " + str(hd([_x334]).foo));
  } else {
    passed = passed + 1;
  }
  var _x336 = [];
  _x336.foo = true;
  if (! equal63(true, hd([_x336]).foo)) {
    failed = failed + 1;
    var _x338 = [];
    _x338.foo = true;
    return("failed: expected " + str(true) + ", was " + str(hd([_x338]).foo));
  } else {
    passed = passed + 1;
  }
  var _x339 = [];
  _x339.foo = true;
  if (! equal63(true, _x339.foo)) {
    failed = failed + 1;
    var _x340 = [];
    _x340.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x340.foo));
  } else {
    passed = passed + 1;
  }
  var _x342 = [];
  _x342.foo = true;
  if (! equal63(true, join([1, 2, 3], _x342).foo)) {
    failed = failed + 1;
    var _x344 = [];
    _x344.foo = true;
    return("failed: expected " + str(true) + ", was " + str(join([1, 2, 3], _x344).foo));
  } else {
    passed = passed + 1;
  }
...
add(tests, ["empty", function () {
  ...
  var _x547 = [];
  _x547.a = true;
  if (! equal63(false, empty63(_x547))) {
    failed = failed + 1;
    var _x548 = [];
    _x548.a = true;
    return("failed: expected " + str(false) + ", was " + str(empty63(_x548)));
  } else {
    passed = passed + 1;
  }
  ...
  var _x549 = [];
  _x549.b = false;
  if (! equal63(false, empty63(_x549))) {
    failed = failed + 1;
    var _x550 = [];
    _x550.b = false;
    return("failed: expected " + str(false) + ", was " + str(empty63(_x550)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["with", function () {
  ...
  if (! equal63(10, x)) {
    ...
    var _x600 = 9;
    _x600 = _x600 + 1;
    return("failed: expected " + str(10) + ", was " + str(_x600));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["join", function () {
  ...
  var _x684 = ["a"];
  _x684.b = true;
  if (! equal63(_x684, join(["a"], {b: true}))) {
    failed = failed + 1;
    var _x686 = ["a"];
    _x686.b = true;
    return("failed: expected " + str(_x686) + ", was " + str(join(["a"], {b: true})));
  } else {
    passed = passed + 1;
  }
  var _x688 = ["a", "b"];
  ...
  var _x690 = ["b"];
  _x690.b = true;
  if (! equal63(_x688, join(["a"], _x690))) {
    failed = failed + 1;
    var _x691 = ["a", "b"];
    _x691.b = true;
    var _x693 = ["b"];
    _x693.b = true;
    return("failed: expected " + str(_x691) + ", was " + str(join(["a"], _x693)));
  } else {
    passed = passed + 1;
  }
  var _x694 = ["a"];
  ...
  var _x695 = ["a"];
  _x695.b = true;
  if (! equal63(_x694, join(_x695, {b: 10}))) {
    failed = failed + 1;
    var _x696 = ["a"];
    _x696.b = 10;
    var _x697 = ["a"];
    _x697.b = true;
    return("failed: expected " + str(_x696) + ", was " + str(join(_x697, {b: 10})));
  } else {
    passed = passed + 1;
  }
  var _x698 = [];
  ...
  var _x699 = [];
  _x699.b = 10;
  if (! equal63(_x698, join({b: true}, _x699))) {
    failed = failed + 1;
    var _x700 = [];
    _x700.b = 10;
    var _x701 = [];
    _x701.b = 10;
    return("failed: expected " + str(_x700) + ", was " + str(join({b: true}, _x701)));
  } else {
    passed = passed + 1;
  }
  var _x702 = ["a"];
...
add(tests, ["reverse", function () {
  ...
  var _x710 = [1, 2, 3];
  _x710.a = true;
  if (! equal63(_x709, reverse(_x710))) {
    failed = failed + 1;
    var _x711 = [3, 2, 1];
    _x711.a = true;
    var _x712 = [1, 2, 3];
    _x712.a = true;
    return("failed: expected " + str(_x711) + ", was " + str(reverse(_x712)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["map", function () {
  ...
  if (! equal63(_x722, map(function (x) {
    ...
    var _x725 = [1, 2, 3];
    _x725.a = 4;
    return("failed: expected " + str(_x724) + ", was " + str(map(function (x) {
      return(x + 1);
    }, _x725)));
  } else {
    passed = passed + 1;
  ...
  var _x727 = [];
  _x727.a = true;
  if (! equal63(_x726, map(function (x) {
    return(x);
  }, _x727))) {
    failed = failed + 1;
    var _x728 = [];
    ...
    var _x729 = [];
    _x729.a = true;
    return("failed: expected " + str(_x728) + ", was " + str(map(function (x) {
      return(x);
    }, _x729)));
  } else {
    passed = passed + 1;
  ...
  var _x731 = [];
  _x731.b = false;
  if (! equal63(_x730, map(function (x) {
    return(x);
  }, _x731))) {
    failed = failed + 1;
    var _x732 = [];
    ...
    var _x733 = [];
    _x733.b = false;
    return("failed: expected " + str(_x732) + ", was " + str(map(function (x) {
      return(x);
    }, _x733)));
  } else {
    passed = passed + 1;
  ...
  _x735.b = false;
  _x735.a = true;
  if (! equal63(_x734, map(function (x) {
    return(x);
  }, _x735))) {
    failed = failed + 1;
    var _x736 = [];
    ...
    _x737.b = false;
    _x737.a = true;
    return("failed: expected " + str(_x736) + ", was " + str(map(function (x) {
      return(x);
    }, _x737)));
  } else {
    passed = passed + 1;
  ...
  var _x742 = [2, 4, 6];
  _x742.b = 8;
  var _x743 = [1, 2, 3, 4, 5, 6];
  _x743.b = 8;
  _x743.a = 7;
  if (! equal63(_x742, map(evens, _x743))) {
    failed = failed + 1;
    var _x744 = [2, 4, 6];
    _x744.b = 8;
    var _x745 = [1, 2, 3, 4, 5, 6];
    _x745.b = 8;
    _x745.a = 7;
    return("failed: expected " + str(_x744) + ", was " + str(map(evens, _x745)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["cut", function () {
  ...
  var _x772 = [1, 2];
  _x772.a = true;
  if (! equal63(_x771, cut(_x772, 1))) {
    failed = failed + 1;
    var _x773 = [2];
    _x773.a = true;
    var _x774 = [1, 2];
    _x774.a = true;
    return("failed: expected " + str(_x773) + ", was " + str(cut(_x774, 1)));
  } else {
    passed = passed + 1;
  }
  var _x775 = [];
  ...
  if (! equal63(_x775, cut(_x776))) {
    ...
    _x778.b = 2;
    _x778.a = true;
    return("failed: expected " + str(_x777) + ", was " + str(cut(_x778)));
  } else {
    passed = passed + 1;
  }
  var t = [1, 2, 3];
  ...
  var _x781 = [];
  _x781.a = true;
  if (! equal63(_x781, cut(_t1, _35(_t1)))) {
    failed = failed + 1;
    var _x782 = [];
    _x782.a = true;
    return("failed: expected " + str(_x782) + ", was " + str(cut(_t1, _35(_t1))));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["keep", function () {
  ...
  var _x846 = [2, 4, 6];
  _x846.b = 8;
  var _x847 = [1, 2, 3, 4, 5, 6];
  _x847.b = 8;
  _x847.a = 7;
  if (! equal63(_x846, keep(even63, _x847))) {
    failed = failed + 1;
    var _x848 = [2, 4, 6];
    _x848.b = 8;
    var _x849 = [1, 2, 3, 4, 5, 6];
    _x849.b = 8;
    _x849.a = 7;
    return("failed: expected " + str(_x848) + ", was " + str(keep(even63, _x849)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["find", function () {
  ...
  var _x868 = [2, 4];
  _x868.foo = 7;
  if (! equal63(true, in63(7, _x868))) {
    failed = failed + 1;
    var _x869 = [2, 4];
    _x869.foo = 7;
    return("failed: expected " + str(true) + ", was " + str(in63(7, _x869)));
  } else {
    passed = passed + 1;
  }
  var _x870 = [2, 4];
  _x870.bar = true;
  if (! equal63(true, in63(true, _x870))) {
    failed = failed + 1;
    var _x871 = [2, 4];
    _x871.bar = true;
    return("failed: expected " + str(true) + ", was " + str(in63(true, _x871)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["apply", function () {
  ...
  var _x909 = [];
  _x909.foo = 42;
  if (! equal63(42, apply(function (_x907) {
    var _id29 = _x907;
    var foo = _id29.foo;
    return(foo);
  }, [_x909]))) {
    ...
    var _x912 = [];
    _x912.foo = 42;
    return("failed: expected " + str(42) + ", was " + str(apply(function (_x910) {
      var _id30 = _x910;
      var foo = _id30.foo;
      return(foo);
    }, [_x912])));
...
add(tests, ["parameters", function () {
  if (! equal63(42, (function (_x937) {
    var _id31 = _x937;
    var a = _id31[0];
    return(a);
  })([42]))) {
    failed = failed + 1;
    return("failed: expected " + str(42) + ", was " + str((function (_x939) {
      var _id32 = _x939;
      var a = _id32[0];
      return(a);
    })([42])));
  ...
  if (! equal63(42, (function (_x969) {
    ...
    var _x972 = [];
    _x972.foo = 42;
    return("failed: expected " + str(42) + ", was " + str((function (_x971) {
      var _id43 = _x971;
      var foo = _id43.foo;
      return(foo);
    })(_x972)));
  ...
  var _x976 = [];
  _x976.foo = 42;
  if (! equal63([10, 20, 42], _f2(10, _x976, {_stash: true, bar: 20}))) {
    failed = failed + 1;
    var _x978 = [];
    _x978.foo = 42;
    return("failed: expected " + str([10, 20, 42]) + ", was " + str(_f2(10, _x978, {_stash: true, bar: 20})));
  } else {
    passed = passed + 1;
  }
  var _f3 = function () {
