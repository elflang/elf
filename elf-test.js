...
add(tests, ["list", function () {
  ...
  var _x125 = [1];
  _x125.foo = 17;
  if (! equal63(17, _x125.foo)) {
    failed = failed + 1;
    var _x126 = [1];
    _x126.foo = 17;
    return("failed: expected " + str(17) + ", was " + str(_x126.foo));
  } else {
    passed = passed + 1;
  }
  var _x127 = [];
  ...
  var _x129 = [];
  _x129.foo = true;
  if (! equal63(true, _x129.foo)) {
    failed = failed + 1;
    var _x130 = [];
    _x130.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x130.foo));
  } else {
    passed = passed + 1;
  }
  var _x132 = [];
  _x132.foo = true;
  if (! equal63(true, hd([_x132]).foo)) {
    failed = failed + 1;
    var _x134 = [];
    _x134.foo = true;
    return("failed: expected " + str(true) + ", was " + str(hd([_x134]).foo));
  } else {
    passed = passed + 1;
  }
  var _x135 = [];
...
add(tests, ["quasiquote", function () {
  ...
  var _x317 = [];
  _x317.foo = true;
  if (! equal63(true, _x317.foo)) {
    failed = failed + 1;
    var _x318 = [];
    _x318.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x318.foo));
  } else {
    passed = passed + 1;
  }
  var _a1 = 17;
  ...
  var _x323 = [];
  _x323.foo = _a1;
  if (! equal63(2, _35(join(_x323, b)))) {
    failed = failed + 1;
    var _x324 = [];
    _x324.foo = _a1;
    return("failed: expected " + str(2) + ", was " + str(_35(join(_x324, b))));
  } else {
    passed = passed + 1;
  }
  var _x325 = [];
  _x325.foo = _a1;
  if (! equal63(17, _x325.foo)) {
    failed = failed + 1;
    var _x326 = [];
    _x326.foo = _a1;
  ...
  var _x327 = [1];
  _x327.a = 10;
  if (! equal63(_x327, join([1], _c))) {
    failed = failed + 1;
    var _x329 = [1];
    _x329.a = 10;
    return("failed: expected " + str(_x329) + ", was " + str(join([1], _c)));
  } else {
    passed = passed + 1;
  }
  var _x331 = [1];
  _x331.a = 10;
  if (! equal63(_x331, join([1], d))) {
    failed = failed + 1;
    var _x333 = [1];
    _x333.a = 10;
    return("failed: expected " + str(_x333) + ", was " + str(join([1], d)));
  } else {
    passed = passed + 1;
  }
  var _x336 = [];
  ...
  var _x340 = [];
  _x340.foo = true;
  if (! equal63(true, hd([_x340]).foo)) {
    failed = failed + 1;
    var _x342 = [];
    _x342.foo = true;
    return("failed: expected " + str(true) + ", was " + str(hd([_x342]).foo));
  } else {
    passed = passed + 1;
  }
  var _x343 = [];
  _x343.foo = true;
  if (! equal63(true, _x343.foo)) {
    failed = failed + 1;
    var _x344 = [];
    _x344.foo = true;
    return("failed: expected " + str(true) + ", was " + str(_x344.foo));
  } else {
    passed = passed + 1;
  }
  var _x346 = [];
  _x346.foo = true;
  if (! equal63(true, join([1, 2, 3], _x346).foo)) {
    failed = failed + 1;
    var _x348 = [];
    _x348.foo = true;
    return("failed: expected " + str(true) + ", was " + str(join([1, 2, 3], _x348).foo));
  } else {
    passed = passed + 1;
  }
...
add(tests, ["empty", function () {
  ...
  var _x550 = [];
  _x550.a = true;
  if (! equal63(false, empty63(_x550))) {
    failed = failed + 1;
    var _x551 = [];
    _x551.a = true;
    return("failed: expected " + str(false) + ", was " + str(empty63(_x551)));
  } else {
    passed = passed + 1;
  }
...
add(tests, ["with", function () {
  ...
  if (! equal63(10, x)) {
    ...
    var _x603 = 9;
    _x603 = _x603 + 1;
    return("failed: expected " + str(10) + ", was " + str(_x603));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["join", function () {
  ...
  var _x687 = ["a"];
  _x687.b = true;
  if (! equal63(_x687, join(["a"], {b: true}))) {
    failed = failed + 1;
    var _x689 = ["a"];
    _x689.b = true;
    return("failed: expected " + str(_x689) + ", was " + str(join(["a"], {b: true})));
  } else {
    passed = passed + 1;
  }
  var _x691 = ["a", "b"];
  ...
  var _x693 = ["b"];
  _x693.b = true;
  if (! equal63(_x691, join(["a"], _x693))) {
    failed = failed + 1;
    var _x694 = ["a", "b"];
    _x694.b = true;
    var _x696 = ["b"];
    _x696.b = true;
    return("failed: expected " + str(_x694) + ", was " + str(join(["a"], _x696)));
  } else {
    passed = passed + 1;
  }
  var _x697 = ["a"];
  ...
  var _x698 = ["a"];
  _x698.b = true;
  if (! equal63(_x697, join(_x698, {b: 10}))) {
    failed = failed + 1;
    var _x699 = ["a"];
    _x699.b = 10;
    var _x700 = ["a"];
    _x700.b = true;
    return("failed: expected " + str(_x699) + ", was " + str(join(_x700, {b: 10})));
  } else {
    passed = passed + 1;
  }
  var _x701 = [];
  ...
  var _x702 = [];
  _x702.b = 10;
  if (! equal63(_x701, join({b: true}, _x702))) {
    failed = failed + 1;
    var _x703 = [];
    _x703.b = 10;
    var _x704 = [];
    _x704.b = 10;
    return("failed: expected " + str(_x703) + ", was " + str(join({b: true}, _x704)));
  } else {
    passed = passed + 1;
  }
  var _x705 = ["a"];
...
add(tests, ["reverse", function () {
  ...
  var _x713 = [1, 2, 3];
  _x713.a = true;
  if (! equal63(_x712, reverse(_x713))) {
    failed = failed + 1;
    var _x714 = [3, 2, 1];
    _x714.a = true;
    var _x715 = [1, 2, 3];
    _x715.a = true;
    return("failed: expected " + str(_x714) + ", was " + str(reverse(_x715)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["map", function () {
  ...
  var _x730 = [];
  _x730.a = true;
  if (! equal63(_x729, map(function (x) {
    return(x);
  }, _x730))) {
    failed = failed + 1;
    var _x731 = [];
    ...
    var _x732 = [];
    _x732.a = true;
    return("failed: expected " + str(_x731) + ", was " + str(map(function (x) {
      return(x);
    }, _x732)));
  } else {
    passed = passed + 1;
  ...
  var _x734 = [];
  _x734.b = false;
  if (! equal63(_x733, map(function (x) {
    return(x);
  }, _x734))) {
    failed = failed + 1;
    var _x735 = [];
    ...
    var _x736 = [];
    _x736.b = false;
    return("failed: expected " + str(_x735) + ", was " + str(map(function (x) {
      return(x);
    }, _x736)));
  } else {
    passed = passed + 1;
  ...
  _x738.b = false;
  _x738.a = true;
  if (! equal63(_x737, map(function (x) {
    return(x);
  }, _x738))) {
    failed = failed + 1;
    var _x739 = [];
    ...
    _x740.b = false;
    _x740.a = true;
    return("failed: expected " + str(_x739) + ", was " + str(map(function (x) {
      return(x);
    }, _x740)));
  } else {
    passed = passed + 1;
  ...
  var _x745 = [2, 4, 6];
  _x745.b = 8;
  var _x746 = [1, 2, 3, 4, 5, 6];
  _x746.b = 8;
  _x746.a = 7;
  if (! equal63(_x745, map(evens, _x746))) {
    failed = failed + 1;
    var _x747 = [2, 4, 6];
    _x747.b = 8;
    var _x748 = [1, 2, 3, 4, 5, 6];
    _x748.b = 8;
    _x748.a = 7;
    return("failed: expected " + str(_x747) + ", was " + str(map(evens, _x748)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["cut", function () {
  ...
  var _x775 = [1, 2];
  _x775.a = true;
  if (! equal63(_x774, cut(_x775, 1))) {
    failed = failed + 1;
    var _x776 = [2];
    _x776.a = true;
    var _x777 = [1, 2];
    _x777.a = true;
    return("failed: expected " + str(_x776) + ", was " + str(cut(_x777, 1)));
  } else {
    passed = passed + 1;
  }
  var _x778 = [];
  ...
  if (! equal63(_x778, cut(_x779))) {
    ...
    _x781.b = 2;
    _x781.a = true;
    return("failed: expected " + str(_x780) + ", was " + str(cut(_x781)));
  } else {
    passed = passed + 1;
  }
  var t = [1, 2, 3];
  ...
  var _x784 = [];
  _x784.a = true;
  if (! equal63(_x784, cut(_t1, _35(_t1)))) {
    failed = failed + 1;
    var _x785 = [];
    _x785.a = true;
    return("failed: expected " + str(_x785) + ", was " + str(cut(_t1, _35(_t1))));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["keep", function () {
  ...
  var _x849 = [2, 4, 6];
  _x849.b = 8;
  var _x850 = [1, 2, 3, 4, 5, 6];
  _x850.b = 8;
  _x850.a = 7;
  if (! equal63(_x849, keep(even63, _x850))) {
    failed = failed + 1;
    var _x851 = [2, 4, 6];
    _x851.b = 8;
    var _x852 = [1, 2, 3, 4, 5, 6];
    _x852.b = 8;
    _x852.a = 7;
    return("failed: expected " + str(_x851) + ", was " + str(keep(even63, _x852)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["find", function () {
  ...
  var _x871 = [2, 4];
  _x871.foo = 7;
  if (! equal63(true, in63(7, _x871))) {
    failed = failed + 1;
    var _x872 = [2, 4];
    _x872.foo = 7;
    return("failed: expected " + str(true) + ", was " + str(in63(7, _x872)));
  } else {
    passed = passed + 1;
  }
  var _x873 = [2, 4];
  _x873.bar = true;
  if (! equal63(true, in63(true, _x873))) {
    failed = failed + 1;
    var _x874 = [2, 4];
    _x874.bar = true;
    return("failed: expected " + str(true) + ", was " + str(in63(true, _x874)));
  } else {
    passed = passed + 1;
    return(passed);
  }
...
add(tests, ["apply", function () {
  ...
  var _x912 = [];
  _x912.foo = 42;
  if (! equal63(42, apply(function (_x910) {
    var _id29 = _x910;
    var foo = _id29.foo;
    return(foo);
  }, [_x912]))) {
    ...
    var _x915 = [];
    _x915.foo = 42;
    return("failed: expected " + str(42) + ", was " + str(apply(function (_x913) {
      var _id30 = _x913;
      var foo = _id30.foo;
      return(foo);
    }, [_x915])));
...
add(tests, ["parameters", function () {
  if (! equal63(42, (function (_x940) {
    var _id31 = _x940;
    var a = _id31[0];
    return(a);
  })([42]))) {
    failed = failed + 1;
    return("failed: expected " + str(42) + ", was " + str((function (_x942) {
      var _id32 = _x942;
      var a = _id32[0];
      return(a);
    })([42])));
  ...
  if (! equal63(42, (function (_x972) {
    ...
    var _x975 = [];
    _x975.foo = 42;
    return("failed: expected " + str(42) + ", was " + str((function (_x974) {
      var _id43 = _x974;
      var foo = _id43.foo;
      return(foo);
    })(_x975)));
  ...
  var _x979 = [];
  _x979.foo = 42;
  if (! equal63([10, 20, 42], _f2(10, _x979, {_stash: true, bar: 20}))) {
    failed = failed + 1;
    var _x981 = [];
    _x981.foo = 42;
    return("failed: expected " + str([10, 20, 42]) + ", was " + str(_f2(10, _x981, {_stash: true, bar: 20})));
  } else {
    passed = passed + 1;
  }
  var _f3 = function () {
