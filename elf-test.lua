...
add(tests, {"empty", function ()
  ...
  local _x550 = {}
  _x550.a = true
  if not equal63(false, empty63(_x550)) then
    failed = failed + 1
    local _x551 = {}
    _x551.a = true
  ...
  local _x552 = {}
  _x552.b = false
  if not equal63(false, empty63(_x552)) then
    failed = failed + 1
    local _x553 = {}
    _x553.b = false
...
add(tests, {"with", function ()
  ...
  if not equal63(10, x) then
    ...
    local _x631 = 9
    _x631 = _x631 + 1
    return("failed: expected " .. str(10) .. ", was " .. str(_x631))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"join", function ()
  ...
  local _x715 = {"a"}
  _x715.b = true
  if not equal63(_x715, join({"a"}, {b = true})) then
    failed = failed + 1
    local _x717 = {"a"}
    _x717.b = true
    return("failed: expected " .. str(_x717) .. ", was " .. str(join({"a"}, {b = true})))
  else
    passed = passed + 1
  end
  local _x719 = {"a", "b"}
  ...
  local _x721 = {"b"}
  _x721.b = true
  if not equal63(_x719, join({"a"}, _x721)) then
    failed = failed + 1
    local _x722 = {"a", "b"}
    _x722.b = true
    local _x724 = {"b"}
    _x724.b = true
    return("failed: expected " .. str(_x722) .. ", was " .. str(join({"a"}, _x724)))
  else
    passed = passed + 1
  end
  local _x725 = {"a"}
  ...
  local _x726 = {"a"}
  _x726.b = true
  if not equal63(_x725, join(_x726, {b = 10})) then
    failed = failed + 1
    local _x727 = {"a"}
    _x727.b = 10
    local _x728 = {"a"}
    _x728.b = true
    return("failed: expected " .. str(_x727) .. ", was " .. str(join(_x728, {b = 10})))
  else
    passed = passed + 1
  end
  local _x729 = {}
  ...
  local _x730 = {}
  _x730.b = 10
  if not equal63(_x729, join({b = true}, _x730)) then
    failed = failed + 1
    local _x731 = {}
    _x731.b = 10
    local _x732 = {}
    _x732.b = 10
    return("failed: expected " .. str(_x731) .. ", was " .. str(join({b = true}, _x732)))
  else
    passed = passed + 1
  end
  local _x733 = {"a"}
...
add(tests, {"reverse", function ()
  ...
  local _x741 = {1, 2, 3}
  _x741.a = true
  if not equal63(_x740, reverse(_x741)) then
    failed = failed + 1
    local _x742 = {3, 2, 1}
    _x742.a = true
    local _x743 = {1, 2, 3}
    _x743.a = true
    return("failed: expected " .. str(_x742) .. ", was " .. str(reverse(_x743)))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"map", function ()
  ...
  local _x754 = {1, 2, 3}
  _x754.a = 4
  if not equal63(_x753, map(function (x)
    return(x + 1)
  end, _x754)) then
    failed = failed + 1
    local _x755 = {2, 3, 4}
    ...
    local _x756 = {1, 2, 3}
    _x756.a = 4
    return("failed: expected " .. str(_x755) .. ", was " .. str(map(function (x)
      return(x + 1)
    end, _x756)))
  else
    passed = passed + 1
  ...
  local _x758 = {}
  _x758.a = true
  if not equal63(_x757, map(function (x)
    return(x)
  end, _x758)) then
    failed = failed + 1
    local _x759 = {}
    ...
    local _x760 = {}
    _x760.a = true
    return("failed: expected " .. str(_x759) .. ", was " .. str(map(function (x)
      return(x)
    end, _x760)))
  else
    passed = passed + 1
  ...
  local _x762 = {}
  _x762.b = false
  if not equal63(_x761, map(function (x)
    return(x)
  end, _x762)) then
    failed = failed + 1
    local _x763 = {}
    ...
    local _x764 = {}
    _x764.b = false
    return("failed: expected " .. str(_x763) .. ", was " .. str(map(function (x)
      return(x)
    end, _x764)))
  else
    passed = passed + 1
  ...
  _x766.b = false
  _x766.a = true
  if not equal63(_x765, map(function (x)
    return(x)
  end, _x766)) then
    failed = failed + 1
    local _x767 = {}
    ...
    _x768.b = false
    _x768.a = true
    return("failed: expected " .. str(_x767) .. ", was " .. str(map(function (x)
      return(x)
    end, _x768)))
  else
    passed = passed + 1
  ...
  local _x773 = {2, 4, 6}
  _x773.b = 8
  local _x774 = {1, 2, 3, 4, 5, 6}
  _x774.b = 8
  _x774.a = 7
  if not equal63(_x773, map(evens, _x774)) then
    failed = failed + 1
    local _x775 = {2, 4, 6}
    _x775.b = 8
    local _x776 = {1, 2, 3, 4, 5, 6}
    _x776.b = 8
    _x776.a = 7
    return("failed: expected " .. str(_x775) .. ", was " .. str(map(evens, _x776)))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"cut", function ()
  ...
  local _x803 = {1, 2}
  _x803.a = true
  if not equal63(_x802, cut(_x803, 1)) then
    failed = failed + 1
    local _x804 = {2}
    _x804.a = true
    local _x805 = {1, 2}
    _x805.a = true
    return("failed: expected " .. str(_x804) .. ", was " .. str(cut(_x805, 1)))
  else
    passed = passed + 1
  end
  local _x806 = {}
  ...
  _x807.b = 2
  _x807.a = true
  if not equal63(_x806, cut(_x807)) then
    failed = failed + 1
    local _x808 = {}
    _x808.b = 2
    _x808.a = true
    ...
    _x809.b = 2
    _x809.a = true
    return("failed: expected " .. str(_x808) .. ", was " .. str(cut(_x809)))
  else
    passed = passed + 1
  end
  local t = {1, 2, 3}
  ...
  local _x812 = {}
  _x812.a = true
  if not equal63(_x812, cut(_t1, _35(_t1))) then
    failed = failed + 1
    local _x813 = {}
    _x813.a = true
    return("failed: expected " .. str(_x813) .. ", was " .. str(cut(_t1, _35(_t1))))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"keep", function ()
  ...
  local _x877 = {2, 4, 6}
  _x877.b = 8
  local _x878 = {1, 2, 3, 4, 5, 6}
  _x878.b = 8
  _x878.a = 7
  if not equal63(_x877, keep(even63, _x878)) then
    failed = failed + 1
    local _x879 = {2, 4, 6}
    _x879.b = 8
    local _x880 = {1, 2, 3, 4, 5, 6}
    _x880.b = 8
    _x880.a = 7
    return("failed: expected " .. str(_x879) .. ", was " .. str(keep(even63, _x880)))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"find", function ()
  ...
  local _x899 = {2, 4}
  _x899.foo = 7
  if not equal63(true, in63(7, _x899)) then
    failed = failed + 1
    local _x900 = {2, 4}
    _x900.foo = 7
    return("failed: expected " .. str(true) .. ", was " .. str(in63(7, _x900)))
  else
    passed = passed + 1
  end
  local _x901 = {2, 4}
  _x901.bar = true
  if not equal63(true, in63(true, _x901)) then
    failed = failed + 1
    local _x902 = {2, 4}
    _x902.bar = true
    return("failed: expected " .. str(true) .. ", was " .. str(in63(true, _x902)))
  else
    passed = passed + 1
    return(passed)
  end
...
add(tests, {"apply", function ()
  ...
  local _x946 = {}
  _x946.foo = 42
  if not equal63(42, apply(function (_x944)
    local _id29 = _x944
    local foo = _id29.foo
    return(foo)
  end, {_x946})) then
    ...
    local _x949 = {}
    _x949.foo = 42
    return("failed: expected " .. str(42) .. ", was " .. str(apply(function (_x947)
      local _id30 = _x947
      local foo = _id30.foo
      return(foo)
    end, {_x949})))
...
add(tests, {"parameters", function ()
  if not equal63(42, (function (_x974)
    local _id31 = _x974
    local a = _id31[1]
    return(a)
  end)({42})) then
    failed = failed + 1
    return("failed: expected " .. str(42) .. ", was " .. str((function (_x976)
      local _id32 = _x976
      local a = _id32[1]
      return(a)
    end)({42})))
  ...
  local _x1013 = {}
  _x1013.foo = 42
  if not equal63(42, (function (_x1012)
    local _id42 = _x1012
    local foo = _id42.foo
    return(foo)
  end)(_x1013)) then
    ...
    local _x1015 = {}
    _x1015.foo = 42
    return("failed: expected " .. str(42) .. ", was " .. str((function (_x1014)
      local _id43 = _x1014
      local foo = _id43.foo
      return(foo)
    end)(_x1015)))
  ...
  local _x1020 = {}
  _x1020.foo = 42
  if not equal63({10, 20, 42}, _f2(10, _x1020, {_stash = true, bar = 20})) then
    failed = failed + 1
    local _x1022 = {}
    _x1022.foo = 42
    return("failed: expected " .. str({10, 20, 42}) .. ", was " .. str(_f2(10, _x1022, {_stash = true, bar = 20})))
  else
    passed = passed + 1
  end
  local _f3 = function (...)
