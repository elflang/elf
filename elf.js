var setup = function () {
  ...
  setenv("%eval-arg", {_stash: true, macro: function (v, _x503) {
    var macro = _x503[0];
    var xs = cut(_x503, 1);
...
if (typeof(_x526) === "undefined" || _x526 === null) {
  _x526 = true;
  environment42 = [{}];
  target42 = "js";
}
...
setenv = function (k) {
  ...
  if (typeof(k) === "string") {
    var _e48;
    if (_keys.toplevel) {
      _e48 = environment42[0];
    } else {
      _e48 = last(environment42);
    }
    var frame = _e48;
    var entry = frame[k] || {};
    var _l19 = _keys;
