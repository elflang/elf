var setup = function () {
  ...
  setenv("nil?", {_stash: true, macro: function (x) {
    ...
    var _e24;
    if (!( typeof(x) === "object")) {
      _e24 = ["or", ["is", ["typeof", x], ["quote", "undefined"]], ["is", x, "null"]];
    } else {
      _e24 = ["let", ["x", x], ["nil?", "x"]];
    }
    _x410.js = _e24;
...
if (typeof(_x486) === "undefined" || _x486 === null) {
  _x486 = true;
  environment42 = [{}];
  target42 = "js";
}
...
setenv = function (k) {
  ...
  if (typeof(k) === "string") {
    var _e41;
    if (_keys.toplevel) {
      _e41 = environment42[0];
    } else {
      _e41 = last(environment42);
    }
    var frame = _e41;
    var entry = frame[k] || {};
    var _l18 = _keys;
