var setup = function () {
  ...
  setenv("nil?", {_stash: true, macro: function (x) {
    ...
    var _e32;
    if (!( typeof(x) === "object")) {
      _e32 = ["or", ["is", ["typeof", x], "\"undefined\""], ["is", x, "null"]];
    } else {
      _e32 = ["let", ["x", x], ["nil?", "x"]];
    }
    _x421.js = _e32;
  ...
  setenv("%eval-arg", {_stash: true, macro: function (v, _x509) {
    var macro = _x509[0];
    var xs = cut(_x509, 1);
...
if (typeof(_x532) === "undefined" || _x532 === null) {
  _x532 = true;
  environment42 = [{}];
  target42 = "js";
}
...
setenv = function (k) {
  ...
  if (typeof(k) === "string") {
    var _e50;
    if (_keys.toplevel) {
      _e50 = environment42[0];
    } else {
      _e50 = last(environment42);
    }
    var frame = _e50;
    var entry = frame[k] || {};
    var _l19 = _keys;
