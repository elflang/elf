local function setup()
  ...
  setenv("for-1", {_stash = true, macro = function (_x291, ...)
    local _id51 = _x291
    local i = _id51[1]
    local from = _id51[2]
    local to = _id51[3]
...
function first(f, l)
  local _x431 = l
  local _n11 = _35(_x431)
  local _i11 = 0
  while _i11 < _n11 do
    local x = _x431[_i11 + 1]
    local y = f(x)
    if y then
      return(y)
    end
...
function map(f, x)
  local t = {}
  local _x433 = x
  local _n12 = _35(_x433)
  local _i12 = 0
  while _i12 < _n12 do
    local v = _x433[_i12 + 1]
    local y = f(v)
    if is63(y) then
      add(t, y)
    end
